            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#portfolio">Kategori</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#about">Produk</a></li>
                ...
                <ul class="timeline">
                    <li>
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-muted">Mau beli smartphone android online berkualitas dengan harga murah terbaru 2020 ditokoucs! pembayaran mudah pengiriman cepat siahkan belanja di sini  </p> <a href="{{url('produk')}}" class="btn btn-sm btn-success">Belanja</a> </div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-muted">Dapatkan harga TV special hari ini. free ongkir dan bisa di cicil hingga 24 bulan.  </p><a href="{{url('produk')}}" class="btn btn-sm btn-success">Belanja</a> </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-muted">Jual leptop online terbaru-harga, promo dan diskon di tokoucs dengan fasilitas belanja online terbaik.</p><a href="{{url('produk')}}" class="btn btn-sm btn-success">Belanja</a> </div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-muted">Dapatkan printer di indonesi. cek penawaran dan ulasan jual beli pinter online aman garansi di tokoucs .</p><a href="{{url('produk')}}" class="btn btn-sm btn-success">Belanja</a> </div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal3">
                                ...
                                <img class="img-fluid" src="{{url('public')}}/assets/img/portfolio/realme c15.jpg" alt="" />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Realme</div>
                                <div class="portfolio-caption-subheading text-muted">Realme C15</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="justify-content-center  text-center">
                    <button class="btn btn-primary">Info Lebih  Lanjut</button>
                </div>
            </div>
        </section>
        ...
        <section class="page-section bg-light" id="team">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="{{url('public')}}/assets/img/team/2.jpg" alt="" />
                            <h4>Larry Parker</h4>
                    ...
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="{{url('public')}}/assets/img/team/3.jpg" alt="" />
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid d-block mx-auto" src="{{url('public')}}/assets/img/logos/envato.jpg" alt="" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid d-block mx-auto" src="{{url('public')}}/assets/img/logos/designmodo.jpg" alt="" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid d-block mx-auto" src="{{url('public')}}/assets/img/logos/themeforest.jpg" alt="" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid d-block mx-auto" src="{{url('public')}}/assets/img/logos/creative-market.jpg" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
